...
for i in [50]:
    ...
    simulate(amount_of_particles=amount_of_particles, interaction_strength=interaction_strength, frames=1800, box_size=box_size, monte_carlo_steps_per_frame=10000)
