...
def simulate(amount_of_particles = 100, interaction_strength = 1, frames=100, monte_carlo_steps_per_frame=None, temperature = 300, box_size = 30, particle_radius = 1, starting_position = 'random'):
    global UM
    ...
    for s in range(frames):
        ...
        #save simulation
        np.savez(f'position data/{interaction_strength}_kT {N}_particles.npz',
                 pos=history,           ##animation information
                 BOX_SIZE=box_size,
                 PARTICLE_RADIUS=a,
